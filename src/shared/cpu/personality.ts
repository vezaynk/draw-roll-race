// The tutorial CPU's personality comes from its seed: how fast its limbs spin, how quickly it
// reacts, how far ahead it looks, and its own versions of each shape.
...
export default function personality(seed: number): Personality {
  const d = TUNING;
